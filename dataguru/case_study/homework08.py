...
outputfile = 'd:/data/example08/gls_jd.txt' #评论提取后保存路径
data = pd.read_csv(inputfile, encoding = 'utf-8')
data = data[[u'评论']][data[u'品牌'] == u'格兰仕']
data.to_csv(outputfile, index = False, header = False, encoding = 'utf-8')


###数据预处理###
#文本去重
inputfile = 'd:/data/example08/gls_jd.txt' #评论文件
outputfile = 'd:/data/example08/gls_jd_process_1.txt' #评论处理后保存路径

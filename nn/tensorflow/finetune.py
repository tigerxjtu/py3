...
# 处理好之后的数据文件。
INPUT_DATA = 'C:/dataguru_new/Tensorflow/work05/dogcat.npy'
# 保存训练好的模型的路径。
TRAIN_FILE = 'C:/dataguru_new/Tensorflow/work05/model'
# 谷歌提供的训练好的模型文件地址。因为GitHub无法保存大于100M的文件，所以
# 在运行时需要先自行从Google下载inception_v3.ckpt文件。
CKPT_FILE = 'C:/dataguru_new/Tensorflow/work7/inception_v3.ckpt'
